...
```
Answer : the Africa is most density continent and the south America is the most continent in plastic wate per cap.
...
ggplot(data = plastic_waste, 
  ...
  geom_violin()
```
Answer : Box plots provide a coarser summary of the data , provide more of a summary of a distribution can also be seen as an advantage in certain cases , also the point in the graph or mapping it's most clearly then violin plots.
...
ggplot(data = plastic_waste, 
  ...
  geom_point()
```
Answer : Europe ( Positive) relationship , Africa is the most (mismanged _ plastice waste per cap)  
