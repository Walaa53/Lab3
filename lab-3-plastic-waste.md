...
certain cases , also the point in the graph or mapping it’s most clearly
then violin plots.
...
Answer : Europe ( Positive) relationship , Africa is the most (mismanged
\_ plastice waste per cap)
...
![](lab-3-plastic-waste_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
